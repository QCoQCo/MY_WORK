...
export const selfIntroSections: SelfIntroSection[] = [
  {
    icon: '📌',
    title: { ko: '강점 및 어필 포인트', ja: 'アピールポイント' },
    body: {
  ...
  {
    icon: '📚',
    title: { ko: '특기 및 좋아하는 과목', ja: '特技・好きな学科' },
    body: {
  ...
  {
    icon: '🌏',
    title: { ko: '일본 취업 희망 사유', ja: '日本で仕事をしたいと思う理由' },
    body: {
  ...
  {
    icon: '🔥',
    title: { ko: '학업 외 학창 시절 노력한 점', ja: '学業以外で学生時代に力を注いだこと' },
    body: {
